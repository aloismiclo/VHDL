...
HD_PWD='C:/Users/alois/Documents/Perso/M2_SE/VHDL/Compteur_Bascule/Compteur_Bascule.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Global.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Global.tcl
