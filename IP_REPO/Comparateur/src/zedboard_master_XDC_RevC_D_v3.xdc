...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {H}];  # "GCLK"

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {S[0]}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {S[7]}];  # "JA10"
...
set_property PACKAGE_PIN AB11 [get_ports {S[4]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {S[5]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {S[6]}];  # "JA9"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {DOWNUP}];  # "SW0"
